...
[][nextjournal#file#e2291f52-f5d8-452f-ad46-ecb7428b8249]
...
```python no-exec id=dc0359c5-7ce6-4ee6-9e3b-376fa8eac6cf
...
```python id=561789a7-347d-4f8f-b308-9cb0017075d3
name = input('Enter file:')
handle = open(name, 'r')
counts = dict()
